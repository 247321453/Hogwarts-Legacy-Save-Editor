...
export class SaveGameDB
{
    ...
    async getPlayerData() : Promise<PlayerData>
    {
        ...
        return {
            FirstName: firstNameData[0].values[0][0] as string,
            LastName: lastNameData[0].values[0][0] as string,
            House: houseData[0].values[0][0] as string,
            Exp: expData[0].values[0][0] as string,
            Level: levelData[0].values[0][0] as string,
            PerkPoints: perkData[0].values[0][0] as string,
            BaseInventoryCapacity: baseInvCap[0].values[0][0] as string
        };
    }
